...
vi.mock(
  "@/features/users/presentation/components/delegates/AsSellerRow",
  () => ({
...
vi.mock(
  "@/features/users/presentation/components/delegates/AsDelegateRow",
  () => ({
...
import { UserDelegatesCard } from "@/features/users/presentation/components/UserDelegatesCard";
