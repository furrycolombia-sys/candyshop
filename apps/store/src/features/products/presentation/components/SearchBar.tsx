  ...
  return (
    <div className="relative" {...tid("search-bar")}>
      ...
      <input
        ...
        className="w-full border-[3px] border-foreground bg-background pl-9 pr-4 py-2 text-sm font-medium placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-foreground focus:ring-offset-0 rounded-none"
        aria-label={t("search")}
