...
vi.mock(
  "@/features/products/presentation/components/product-detail/HeroSection",
  () => ({
...
vi.mock(
  "@/features/products/presentation/components/product-detail/DescriptionSection",
  () => ({
...
vi.mock(
  "@/features/products/presentation/components/product-detail/sections",
  () => ({
