...
import { HeroSection } from "@/features/products/presentation/components/ProductDetail/HeroSection";
...
vi.mock(
  "@/features/products/presentation/components/ProductDetail/ImageGallery",
  () => ({
...
vi.mock(
  "@/features/products/presentation/components/ProductDetail/PriceBlock",
  () => ({
...
vi.mock(
  "@/features/products/presentation/components/ProductDetail/RatingStars",
  () => ({
