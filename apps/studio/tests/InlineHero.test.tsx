...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/InlineImageCarousel",
  () => ({
...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/InlinePriceFields",
  () => ({
...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/InlineTagEditor",
  () => ({
...
import { InlineHero } from "@/features/products/presentation/components/InlineEditor/InlineHero";
