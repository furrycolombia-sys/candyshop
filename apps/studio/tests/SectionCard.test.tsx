...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/AutoTextarea",
  () => ({
    AutoTextarea: ({
      value,
      placeholder,
...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/InlineRemoveButton",
  () => ({
    InlineRemoveButton: ({
      onClick,
      ariaLabel,
...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/SectionItemsAccordion",
  () => ({
...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/SectionItemsCards",
  () => ({
...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/SectionItemsGallery",
  () => ({
    SectionItemsGallery: () => (
...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/SectionItemsTwoColumn",
  () => ({
...
import { SectionCard } from "@/features/products/presentation/components/InlineEditor/SectionCard";
