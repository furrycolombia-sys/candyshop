...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/IconPicker",
  () => ({
    IconPicker: () => <div data-testid="icon-picker" />,
  }),
);

import { SectionItemsCards } from "@/features/products/presentation/components/InlineEditor/SectionItemsCards";
