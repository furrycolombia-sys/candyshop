...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/PriceInput",
  () => ({
...
import { InlinePriceFields } from "@/features/products/presentation/components/InlineEditor/InlinePriceFields";
