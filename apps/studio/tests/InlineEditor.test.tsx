...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/EditorToolbar",
  () => ({
...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/FormErrorBanner",
  () => ({
...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/MutationErrorBanner",
  () => ({
...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/InlineHero",
  () => ({
...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/InlineSections",
  () => ({
...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/InlineTextField",
  () => ({
...
import { InlineEditor } from "@/features/products/presentation/components/InlineEditor/InlineEditor";
