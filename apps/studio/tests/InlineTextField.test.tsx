...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/LangTextarea",
  () => ({
    LangTextarea: ({
      testId,
      visible,
...
import { InlineTextField } from "@/features/products/presentation/components/InlineEditor/InlineTextField";
