...
vi.mock(
  "@/features/products/presentation/components/InlineEditor/TemplatePicker",
  () => ({
    TemplatePicker: () => <div data-testid="template-picker" />,
  }),
);

import { EditorToolbar } from "@/features/products/presentation/components/InlineEditor/EditorToolbar";
