...
vi.mock(
  "@/features/checkout/presentation/components/CheckoutItemsSummary",
  () => ({
...
vi.mock(
  "@/features/checkout/presentation/components/PaymentMethodSelector",
  () => ({
    PaymentMethodSelector: ({
      ...
      <div data-testid="payment-method-selector">
        <button
          data-testid="mock-select-method"
          onClick={() => onSelect("pm-1")}
        >
          Select
        </button>
      </div>
...
vi.mock(
  "@/features/checkout/presentation/components/DisplayBlockRenderer",
  () => ({
...
vi.mock("@/features/checkout/presentation/components/ReceiptUpload", () => ({
  ReceiptUpload: () => <div data-testid="receipt-upload">Upload</div>,
}));

vi.mock("@/features/checkout/presentation/components/DynamicFormField", () => ({
  DynamicFormField: ({
    field,
  }: {
