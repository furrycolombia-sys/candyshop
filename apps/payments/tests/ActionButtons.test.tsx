...
vi.mock(
  "@/features/received-orders/presentation/components/SellerNoteInput",
  () => ({
    SellerNoteInput: ({
      onSubmit,
      onCancel,
...
import { ActionButtons } from "@/features/received-orders/presentation/components/ActionButtons";
