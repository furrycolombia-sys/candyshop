...
# Server-side Supabase URL override (for Docker networking)
ARG SUPABASE_URL_INTERNAL=""
# Base path prefix
ARG BASE_PATH_PREFIX=""
# OAuth providers (needed to satisfy $secret: refs in env files)
ARG SUPABASE_AUTH_EXTERNAL_GOOGLE_CLIENT_ID=""
ARG SUPABASE_AUTH_EXTERNAL_GOOGLE_SECRET=""
ARG SUPABASE_AUTH_EXTERNAL_DISCORD_CLIENT_ID=""
ARG SUPABASE_AUTH_EXTERNAL_DISCORD_SECRET=""
...
ENV SUPABASE_URL_INTERNAL=$SUPABASE_URL_INTERNAL
ENV SUPABASE_SERVICE_ROLE_KEY=$SUPABASE_SERVICE_ROLE_KEY
ENV SITE_PUBLIC_ORIGIN=$SITE_PUBLIC_ORIGIN
ENV BASE_PATH_PREFIX=$BASE_PATH_PREFIX
ENV SUPABASE_AUTH_EXTERNAL_GOOGLE_CLIENT_ID=$SUPABASE_AUTH_EXTERNAL_GOOGLE_CLIENT_ID
ENV SUPABASE_AUTH_EXTERNAL_GOOGLE_SECRET=$SUPABASE_AUTH_EXTERNAL_GOOGLE_SECRET
ENV SUPABASE_AUTH_EXTERNAL_DISCORD_CLIENT_ID=$SUPABASE_AUTH_EXTERNAL_DISCORD_CLIENT_ID
ENV SUPABASE_AUTH_EXTERNAL_DISCORD_SECRET=$SUPABASE_AUTH_EXTERNAL_DISCORD_SECRET
...
# Skip .secrets file loading in Docker builds (secrets come from build args)
ENV CI=true
