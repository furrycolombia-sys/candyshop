...
# ─── Dev (local Supabase) ────────────────────────────────────────
DEV_SUPABASE_ANON_KEY=YOUR_SUPABASE_JWT_KEY
DEV_SUPABASE_SERVICE_ROLE_KEY=YOUR_SUPABASE_JWT_KEY

# ─── Staging (containerized Supabase, tunneled via Cloudflare) ────
STAGING_SUPABASE_ANON_KEY=YOUR_SUPABASE_JWT_KEY
STAGING_SUPABASE_SERVICE_ROLE_KEY=YOUR_SUPABASE_JWT_KEY

# ─── E2E (isolated Supabase on port 64321) ───────────────────────
E2E_SUPABASE_ANON_KEY=YOUR_SUPABASE_JWT_KEY
E2E_SUPABASE_SERVICE_ROLE_KEY=YOUR_SUPABASE_JWT_KEY

# ─── Prod (Supabase Cloud) ───────────────────────────────────────
PROD_SUPABASE_ANON_KEY=YOUR_SUPABASE_JWT_KEY
PROD_SUPABASE_SERVICE_ROLE_KEY=YOUR_SUPABASE_JWT_KEY
